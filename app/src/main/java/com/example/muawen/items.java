...
public class items  {
    ...
    public items(String add_day, String exp_date, long current_wieght, long original_weight, long quantity, long current_quantity, String product_ID, String suggested_item,String suggestion_flag, String sensor) {
        Add_day = add_day;
        Exp_date = exp_date;
